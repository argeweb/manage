...
def upload_code_file(root_path, file_name, files_on_server):
    path_without_theme_dir = "/".join((root_path.replace(themes_dir, "") + "\\" + file_name).split("\\"))
